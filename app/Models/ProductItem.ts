import { BaseModel, column, belongsTo, BelongsTo, hasMany, HasMany, beforeFind, beforeFetch, hasOne, HasOne } from '@ioc:Adonis/Lucid/Orm'
...
export default class ProductItem extends BaseModel {
  ...
  @column()
  public usedProductCondition: 'excellent' | 'good' | 'normal' | 'bad' | 'terrible' // How clean or new the product is if it's used. Null if the product is new (usedProduct = false)
