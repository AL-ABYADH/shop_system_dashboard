          ...
          <form method="POST">
            <div class="py-2">
              <div class="relative">
                ...
                >
                <div class="absolute left-0 top-0 h-full py-1 px-3"><img src="../../../Assets/username.svg" class="h-full"></div>
              </div>
            </div>
            <div class="py-2">
              <div class="relative">
                <input
                  ...
                  class="w-full rounded-md bg-primary-opacity border-0 px-3 py-2 text-xs md:text-sm lg:text-base"
                >
                <div class="absolute left-0 top-0 h-full py-1 px-3"><img src="../../../Assets/password.svg" class="h-full"></div>
              </div>
            </div>
            <div>
              <button
              ...
              ><span class="text-white bg-primary text-xs md:text-sm lg:text-base p-3 rounded-md">تسجيل الدخول</span></button>
            </div>
          </form>
        </div>
      </div>
