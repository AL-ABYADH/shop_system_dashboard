...
export default class Orders extends BaseSchema {
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.integer('payment_method_id').unsigned().references('payment_methods.payment_method_id')
      table
      ...
      table.integer('payment_status_id').unsigned().references('payment_statuses.payment_status_id')
      table.enum('Status', ['Testing', 'Confirmation', 'Sold', 'Canceled']).notNullable()
